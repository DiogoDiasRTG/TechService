...
def opcao_listar():
    ...
    for item in ordens:
        atrasada = " (ATRASADA)" if item.get("atrasada", False) else ""
...
def opcao_inserir():
    ...
    # o cliente é sempre encontrado a partir do equipamento, nunca
    # pedido diretamente -- é assim que a composição funciona
